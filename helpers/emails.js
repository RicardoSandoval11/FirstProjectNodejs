...
export const activateAccountRegister = async(name, email, code) => {
    ...
    await transport.sendMail({
        ...
        html: `<h1 style="text-align:center;">Link</h1><p style="text-align:center;"><a href="${process.env.ACCOUNT_REGISTER_LINK}">Click To Open This Link</a></p><h2 style="text-align:center;">Verification Code</h2><p style="text-align:center;">${code}</p>`
    })
